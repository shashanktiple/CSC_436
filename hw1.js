 ...
 * *****************
 * 
 * Implement the Circle class below. It needs to have a radius(Number) property and a color(String) properties. 
 * Both properties should be set in a constructor
 ...
 * The constructor should only accept a single String parameter as input, the input 
 * format will be as follows: 'Apple,1.00,In Stock'
...
const Product = class Product {
    ...
    static inStock = (products) => {
        return products.filter(x => x.availability == "In Stock");
    }
