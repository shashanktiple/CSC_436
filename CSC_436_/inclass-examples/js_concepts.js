...
*/
 ...
 const Student = require(/Users/shashank/CSC436/inclass-examples);
...
//     printCourses = () => this.courses.forEach(a =>console.log(`A: ${a.name} taken during ${a.quarter}`))
// }
